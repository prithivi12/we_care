<!DOCTYPE html>
    ...
    <body>
        ...
        if(isset($_POST['signup'])){
            ...
            $checkuser=$con->connection->query("SELECT * from usersignup where username='$username'");
            if($checkuser->num_rows==0){
                $storeuser=$con->connection->query("INSERT into usersignup values('','$username','$password')");
                if($storeuser){
                ?>
                <script>
